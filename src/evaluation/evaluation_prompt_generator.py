...
from .evaluation_types import EvalContext, RiskLevel, ComplianceStandard
...
class EvaluationPromptGenerator:
    ...
    def _initialize_prompt_templates(self) -> Dict[str, str]:
        ...
        prompts_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "prompts", "evaluation_prompts")
        ...
        try:
            ...
            self._logger.warning(f"Security template not found at {security_template_path}, using fallback")
            templates["security_focused"] = self._get_fallback_security_template()
        
        # Base evaluation template
        templates["base_evaluation"] = """# PROMPT EVALUATION FRAMEWORK
    ...
    def _get_technology_evaluation_knowledge(
        ...
        for tech in technologies:
            ...
            if best_practices or tools:
                ...
                knowledge[tech] = {
                    "best_practices": domain_practices or best_practices[:3],  # Use some practices if none domain-specific
                    "tools": tools,
    ...
    def _generate_criteria_section(
        ...
        for criterion, weight in criteria.criteria.items():
            ...
            for tech, knowledge in tech_knowledge.items():
                relevant_practices = [p for p in knowledge['best_practices'] 
