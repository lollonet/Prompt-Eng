...
from .interfaces import IResearchValidator, ResearchResult, SearchResult, ResearchQuality
...
class ResearchValidator(IResearchValidator):
    ...
    async def _validate_quantity(self, result: ResearchResult, issues: List[str], suggestions: List[str]) -> float:
    ...
    async def _validate_source_diversity(self, result: ResearchResult, issues: List[str], suggestions: List[str]) -> float:
    ...
    async def _validate_content_quality(self, result: ResearchResult, issues: List[str], suggestions: List[str]) -> float:
        ...
        average_quality = total_quality / len(result.search_results) if result.search_results else 0.0
    ...
    async def _validate_source_credibility(self, result: ResearchResult, issues: List[str], suggestions: List[str]) -> float:
        ...
        average_credibility = total_credibility / len(result.search_results) if result.search_results else 0.0
    ...
    async def _validate_technical_depth(self, result: ResearchResult, issues: List[str], suggestions: List[str]) -> float:
        ...
        for search_result in result.search_results:
            ...
            technical_keywords = ['implement', 'configure', 'setup', 'install', 'deploy', 'architecture']
    ...
    async def _validate_recency(self, result: ResearchResult, issues: List[str], suggestions: List[str]) -> float:
    ...
    async def _detect_bias(self, result: ResearchResult, issues: List[str], suggestions: List[str]) -> float:
        ...
        vendor_ratio = len(vendor_domains) / len(result.search_results) if result.search_results else 0
        ...
        promotional_ratio = promotional_count / len(result.search_results) if result.search_results else 0
