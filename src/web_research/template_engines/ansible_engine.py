...
class AnsibleTemplateEngine(ITemplateEngine):
    ...
    def supported_technologies(self) -> List[str]:
        return [
            "ansible", "automation", "configuration-management", "deployment",
            "linux", "rhel", "ubuntu", "centos", "debian", "systemd",
            "nginx", "apache", "postgresql", "mysql", "redis", "docker",
            "prometheus", "grafana", "ssl", "firewall", "users", "packages"
        ]
    ...
    def _initialize_role_templates(self) -> Dict[str, Dict]:
        ...
        return {
            ...
            "docker": {
                ...
                "tasks": ["install_docker", "configure_daemon", "setup_compose", "manage_containers"]
            },
            "monitoring": {
                "description": "Monitoring stack deployment",
                "tasks": ["install_prometheus", "configure_grafana", "setup_alerting", "create_dashboards"]
            },
            "security": {
    ...
    def can_handle(self, context: TemplateContext) -> bool:
        ...
        automation_keywords = [
            "deploy", "install", "configure", "setup", "automate", 
            "provision", "manage", "orchestrate", "playbook"
        ]
    ...
    async def generate_template(self, context: TemplateContext) -> TemplateResult:
        ...
        if self.estimate_complexity(context) == "complex":
            template_content = self._generate_role_based_playbook(technologies, context, ansible_config, scenario)
        else:
            template_content = self._generate_simple_playbook(technologies, context, ansible_config, scenario)
    ...
    def _generate_tasks_for_scenario(self, scenario: str, technologies: List[str], context: TemplateContext) -> List[str]:
  ...
  tags: firewall"""
    ...
    def _generate_role_structure(self, role: str, technologies: List[str], context: TemplateContext) -> List[str]:
    ...
    def _generate_execution_instructions(self, context: TemplateContext, ansible_config: AnsibleConfiguration) -> str:
    ...
    def _generate_role_deployment_instructions(self, context: TemplateContext, ansible_config: AnsibleConfiguration, roles: List[str]) -> str:
        ...
        instructions = [
            ...
            "mkdir -p roles/{" + ",".join(roles) + "}/{tasks,handlers,templates,vars,defaults,meta}",
            "",
            "# Initialize roles",
        ]
