...
from src.events import Event, EventBus, EventType, event_bus, setup_default_event_handlers
...
class TestPerformanceIntegration:
    ...
    def test_performance_gates_integration(self, integrated_system_setup):
        ...
        perf_gate = PerformanceGate(
            api_response_threshold_ms=200, memory_growth_threshold_percent=10
        )
    ...
    def test_complete_development_workflow(self, integrated_system_setup):
        ...
        for workflow in workflows:
            ...
            workflow_results.append(
                {"phase": workflow["phase"], "prompt": prompt, "length": len(prompt)}
            )
