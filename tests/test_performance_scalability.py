...
{% endfor %}
        ...
        tools = {
            "pytest": {"name": "pytest", "description": "Python testing framework", "usage": "pytest tests/"},
            "black": {"name": "black", "description": "Python code formatter", "usage": "black src/"},
            "mypy": {"name": "mypy", "description": "Static type checker", "usage": "mypy src/"},
            "pylint": {"name": "pylint", "description": "Code analysis tool", "usage": "pylint src/"},
            "jest": {"name": "jest", "description": "JavaScript testing", "usage": "npm test"},
            "eslint": {"name": "eslint", "description": "JavaScript linter", "usage": "eslint src/"}
        }
