...
from src.events import (
    Event, EventType, EventBus, PromptGenerationStartedEvent,
    PromptGenerationCompletedEvent, PerformanceThresholdExceededEvent,
    event_bus, performance_monitoring_handler, logging_handler,
    metrics_collection_handler, publish_events, setup_default_event_handlers,
    EventPublishConfig
)
from src.types_advanced import TechnologyName, TaskType
...
class TestEventSystem:
    ...
    def test_specific_event_types(self):
        ...
        start_event = PromptGenerationStartedEvent.create(
            ...
            task_type=TaskType("feature development")
        )
