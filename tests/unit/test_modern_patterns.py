...
from src.result_types import Result, Success, Error, PromptError, KnowledgeError, safe_call, combine_results
...
from src.performance import (
    async_read_text_file, async_load_json_file, monitor_performance,
    performance_tracker, LazyEvaluator, lazy
)
from src.events import (
    event_bus, EventType, Event, PromptGenerationStartedEvent,
    PromptGenerationCompletedEvent, setup_default_event_handlers
)
...
class TestIntegration:
    ...
    async def test_end_to_end_prompt_generation(self, tmp_path):
        ...
        (tools_dir / "pylint.json").write_text(json.dumps({
            "name": "Pylint",
